...
# About App
if app_mode == 'About App':
    st.title('Sign Language Detection Using MediaPipe with Streamlit')
    st.markdown(
        """
        <p style="font-size:18px;">
        This application allows users to:
        <ul>
        <li>Detect and interpret hand gestures using Sign Language to Text functionality.</li>
        <li>Convert spoken words into Sign Language visuals.</li>
        </ul>
        </p>
        """,
        unsafe_allow_html=True
